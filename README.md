...
- ### dj - Получение информации из [Stream Dj](https://streamdj.ru/)
  ...
  <details><summary>Параметры</summary>
    ...
    - djApiKey (Опционально) - API ключ от Stream Dj, необходим для команды skip
  ...
  <details><summary>Доступные команды</summary>
    ...
    - list - Список треков
    - count - Количество треков в плейлисте
    - add + ссылка на ютуб видел - Добавить видео в плейлист
