...
const server = http.createServer(function(req, res) {
	...
	if (pathname.split('/')[1] == 'mine'){
		...
		if (type == 0){
			res.write(' Доступные категории для поиска: \'анекдот\', \'рассказ\', \'стих\', \'афоризма\', \'цитата\', \'тост\', \'статус\'. Для поиска 18+ после категории напишите \'18+\' (толком не отличается от обычных). Например: \'!найти анек 18+\'')
			return res.end()
		}
