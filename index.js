...
dungeonEventsLevel3 = [{
		...
		text: ' в подземелье вы встретили группа бандитов. Они не стали сразу вас убивать и предложили отпустить за 300 золотых монет.',
		good: ' Вы отдали им 300 золотых монет и ушли из подземелья. Золото -300.',
		bad:  ' У вас не оказалось при себе денег и разбойники вас убил. Аккаунт удалён.',
		chance: 50,
		gold: -300
	},{
		text: ' в подземелье вы шли рядом с пропастью и оступились. Из вашего кошелька в пропасть упало несколько монет. Золото -20.',
