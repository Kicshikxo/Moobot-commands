...
dungeonEventsLevel1 = [{
		...
		text: ' на подходе к подземелью лежали несколько золотых монет. Подобрав их вы решили вернуться обратно. Золото +10.',
		chance: 150,
		gold: 10
	},{
		text: ' в подземелье вы встретили скелета. Он был слаб, поэтому вы без труда убили его своим мечом, после чего забрали кошель с монетами, висящий на его поясе, и ушли из подземелья. Золото +50.',
		chance: 75,
		gold: 50
	},{
		...
		good: ' Вы отдали им 200 золотых монет и ушли из подземелья. Золото -200.',
		...
		text: ' в подземелье какой то вы увидели незнакомца, подойдя к нему он резко выхватил с вашего пояса кошель и убежал с ним. Вы не смогли его догнать... Золото -100.',
		chance: 50,
		gold: -100
	},{
		text: ' в подземелье вы встретили человека. Он был истощён и не знал как выбраться. Вы проводили его до выхода и дали немного денег. Золото -10.',
		chance: 50,
		gold: -10
	},{
		text: ' в подземелье среди песке вы увидели сверкающий камень. Вам стало интересно что это и вы раскопали его, это оказался алмаз. Золото +100.',
		chance: 50,
		gold: 100
	},{
...
dungeonEventsLevel2 = [{
		...
		text: ' войдя в подземелье нашёл на стенде красивое кольцо. Вы недолго думая взяли его и вынесли с собой. Золото +50.',
		chance: 100,
		gold: 50
	},{
		text: ' на подходе к подземелью лежали несколько золотых монет. Подобрав их вы решили вернуться обратно. Золото +20.',
		chance: 100,
		gold: 20
	},{
		text: ' в подземелье вы встретили скелета. Он был слаб, поэтому вы без труда убили его своим мечом, после чего забрали кошель с монетами, висящий на его поясе, и ушли из подземелья. Золото +75.',
		chance: 75,
		gold: 75
	},{
		text: ' в подземелье вы нашли труп человека. "Вот бедолага" - подумали вы, но увидев на его поясе кошель золота вы обобрали труп и вышли в страхе из подземелья. Золото +50.',
		...
		text: ' в подземелье вы стретили разбойника. Ваше снаряжение позволило вам победить его и забрать его золото. Золото +100',
		chance: 100,
		gold: 0
	},{
		...
		text: ' в подземелье вы шли рядом с пропастью и оступились. Из вашего кошелька в пропасть упало несколько монет. Золото -25.',
		chance: 50,
		gold: -25
	},{
		text: ' в подземелье какой то вы увидели незнакомца, подойдя к нему он резко выхватил с вашего пояса кошель и убежал с ним. Вы не смогли его догнать... Золото -100.',
		...
		text: ' в подземелье вы встретили человека. Он был истощён и не знал как выбраться. Вы проводили его до выхода и дали немного денег. Золото -20.',
		chance: 50,
		gold: -20
	},{
		text: ' в подземелье среди песке вы увидели поблеклый камень. Вам стало интересно что это и вы раскопали его, это оказался долбанит. Золото +200.',
		chance: 50,
		gold: 200
	},{
...
dungeonEventsLevel3 = [{
		...
		text: ' войдя в подземелье вы нашли на стенде красивое кольцо. Вы недолго думая взяли его и вынесли с собой. Золото +50.',
		chance: 50,
		gold: 50
	},{
		text: ' гуляю по подземелью вы вдруг замечаете что в вашем кошельке пропали деньги. Золото -100.',
		chance: 50,
		gold: -100
	},{
		text: ' на подходе к подземелью лежали несколько золотых монет. Подобрав их вы решили вернуться обратно. Золото +20.',
		...
		text: ' гуляю по подземелью вы вдруг замечаете что потеряли свой кошель. Золото -300.',
		chance: 50,
		gold: -300
	},{
		text: ' в подземелье вы встретили скелета. Он был слаб, поэтому вы без труда убили его своим мечом, после чего забрали кошель с монетами, висящий на его поясе, и ушли из подземелья. Золото +75.',
		...
		text: ' в подземелье вы встретили зомби. Вы без труда убили его, после чего забрали кошель с монетами, висящий на его поясе, и ушли из подземелья. Золото +75.',
		chance: 50,
		gold: 75
	},{
		text: ' в подземелье вы нашли труп человека. "Вот бедолага" - подумали вы, но увидев на его поясе кошель золота вы обобрали труп и вышли в страхе из подземелья. Золото +50.',
		...
		good: ' Вы отдали ему 20 золотых монет, но вам стало не по себе и вы вышли из подземелья. Золото -20',
		bad:  ' Но у вас не оказалось при себе денег и человек превратился в чудовище, после чего с лёгкостью вас убил. Аккаунт удалён.',
		chance: 50,
		gold: -20
	},{
		text: ' в подземелье вы встретили группу бандитов. Но ваше снаряжение позволило справиться с ними в одиночку и забрать их запасы. Золото +500',
		chance: 40,
		gold: 500
	},{
		text: ' в подземелье вы шли рядом с пропастью и оступились. Из вашего кошелька в пропасть упало несколько монет. Золото -50.',
		chance: 100,
		gold: -50
	},{
		text: ' в подземелье вы встретили человека. Он был истощён и не знал как выбраться. Вы проводили его до выхода и дали немного денег. Золото -25.',
		chance: 50,
		gold: -25
	},{
		text: ' в подземелье среди песке вы увидели поблеклый камень. Вам стало интересно что это и вы раскопали его, это оказался долбанит. Золото +200.',
		...
		text: ' войдя в подземелье вы встретили огра. Ваше снаряжение позволило вам убить его и забрать сокровища которые он охранял. Золото +1000',
		chance: 10,
		gold: 1000
	}
],
...
commands = {
	...
	dungeon: function(res, collection, user){return new Promise(function(resolve, reject){
		...
		if (options[choice].gold){
			if (options[choice].good){
				if (user.money >= Math.abs(options[choice].gold)) 
					collection.updateOne(user,{$set: {money: Math.max(0, user.money+options[choice].gold)}}, function(error, result){
