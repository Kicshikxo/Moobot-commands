...
dungeonEventsLevel1 = [{
		...
		text: ' в подземелье вы встретили группу хорошо экипированных бандитов. Они не стали сразу вас убивать и предложили отпустить за 300 золотых монет.',
		good: ' Вы отдали им 300 золотых монет и ушли из подземелья. Золото -300.',
...
dungeonEventsLevel2 = [{
		...
		text: ' в подземелье вы встретили разбойника. Его снаряжение было лучше вашего, поэтому он согласился вас отпустить за 50 золотых монет.',
		good: ' Вы отдали ему 50 золотых монет и ушли из подземелья. Золото -50.',
		bad:  ' Но у вас не оказалось при себе денег и разбойник вас убил. Аккаунт удалён.',
		chance: 50,
		gold: -50
	},{
...
dungeonEventsLevel3 = [{
		...
		text: ' в подземелье вы встретили группу бандитов. Но ваше снаряжение позволило справиться с ними в одиночку и забрать их запасы.',
		gold: 500
	},{
