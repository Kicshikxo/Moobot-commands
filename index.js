...
const server = http.createServer(function(req, res) {
	...
	if (pathname == '/ask')
		...
		else res.write('Добро пожаловать в наш волшебный мир! Хочешь поучаствовать и узнать больше информации?<br>Выбери категорию: персонаж (чтобы узнать, кто ты по жизни), событие (что происходит вокруг твоего персонажа).\nНапример "!rpg персонаж')
	}
	else {
